...
mongoose.connect("mongodb+srv://lakshyaveeravalli:Lakshya%4028@cluster0.4uvvryb.mongodb.net/e-commerce");
...
app.post('/removefromcart', fetchuser, async (req, res) => {
    ...
    res.send("Removed");
     ...
     //Create an endpoint for saving the product in wishlist
